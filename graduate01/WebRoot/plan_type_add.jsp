				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							</li>							<li>								<a href="index.jsp">类型管理</a> 								<span class="icon-angle-right"></span>							</li>							<li>								<a href="index.jsp">计划类型管理</a> 								<span class="icon-angle-right"></span>							</li>
							<li><a href="#">添加计划类型</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
							...
							<div class="portlet-body form">
								<div class="tabbable portlet-tabs">
									<ul class="nav nav-tabs">
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">添加计划类型</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-pane active" id="portlet_tab1">
											<!-- BEGIN FORM-->
											<form  class="form-horizontal" action="planType/addPlanType.action" method="post">
