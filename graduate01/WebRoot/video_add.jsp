	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
				<div class="row-fluid">					<form  id="fileupload" action="video/addVideo.action" method="GET" enctype="multipart/form-data" class="form-horizontal">										<div class="control-group">										<label class="control-label" style="width:70px;padding-left:10px;text-align: left">视频标题<span class="required">*</span></label>										<div >											<input type="text" name="name" data-required="1" class="span6 m-wrap"/>										</div>									</div>									<div class="control-group">										<label class="control-label" style="width:70px;padding-left:10px;text-align: left">标签<span class="required">*</span></label>										<div >											<input type="text" name="name" data-required="1" class="span6 m-wrap"/>										</div>									</div>					
					<div class="span12">
