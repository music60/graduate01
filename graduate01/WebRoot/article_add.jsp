							...
							<div class="portlet-body form">
								<div class="tabbable portlet-tabs">
									<ul class="nav nav-tabs">
										<li class="active"><a href="#portlet_tab1" data-toggle="tab">添加文章</a></li>
									</ul>
										...
										<div class="tab-pane active" id="portlet_tab1">
											...
											<form  class="form-horizontal" action="article/addArticle.action" method="post">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" placeholder="请输入标题" class="m-wrap large" name="title"/>
														<span class="help-inline">请尽量限制在20字以内</span>
													</div>
												</div>																								<div class="control-group">													<label class="control-label">文章标签</label>													<div class="controls">														<input id="tags_1" type="text" class="m-wra tags" value="" name="tag" />														<!-- <span class="help-inline">简单的介绍改文章，可以指引用户，尽量分组标明</span> -->													</div>												</div>												<input type="hidden" name="userid" palceholder="标题" value="1" />    											<input type="hidden" name="type" palceHolder="類型" value="aavv"/>
